...
| Th Sep 18 | Univariate random variables<br>+Binary<br>+Nominal categorical<br>Rules of probability<br>+ Total prob<br>+ compliment<br>+ PMF<br>+ CPF<br>+ Generate draws<br>+ Visualizations | [HW: Data manipulation with pandas](homework/06-intro-to-pandas.md)|
